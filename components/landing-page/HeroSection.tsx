          ...
          <div className="flex flex-col md:flex-row gap-8 items-start min-h-[70vh]">
            ...
            <div className="md:w-1/2 mb-16 max-w-4xl text-left items-start flex flex-col gap-4">
              ...
              <p className="text-2xl text-gray-300">
                We're revolutionising how Intelligence Systems are trained and
                scaled.
              </p>
              <p className="mb-8 max-w-3xl text-xl text-gray-400 sm:mx-auto">
                We believe in collective open-source AI data creation which
                empowers everyone to train and deploy frontiers agents and
                models. Join our global community of 100+ domain experts and
                earn by contributing to our 'Trayner Vault'.
              </p>
